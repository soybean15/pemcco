...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-dropdown.item label=" {{ __('Profile') }}" :href="route('profile')"/>
                    <x-dropdown.item separator label=" {{ __('Log Out') }}" wire:click="logout" />
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.members')" :active="request()->routeIs('admin.members')" wire:navigate>
                {{ __('Members') }}
            </x-responsive-nav-link>
        </div>
